...
int main(void) {
    ...
    return (int)(sizeof(values) / sizeof(values[0]))
        + (int)(sizeof(Scores) / sizeof(scores[0]))
        + (int)(sizeof(packet.values) / sizeof(packet.values[0]))
        + (int)(sizeof(packet.label) / sizeof(packet.label[0]))
        + (int)(sizeof(packets) / sizeof(packets[0]))
        + sum_values(values)
        + scores[2]
        + packet.values[1]
        + packets[1].values[2]
