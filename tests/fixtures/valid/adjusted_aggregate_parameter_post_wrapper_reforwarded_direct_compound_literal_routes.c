...
int main(void) {
    ...
    int score = probe(
        reforward_items(
            1
                ...
                : (++a_unselected, forward_items((struct Item[3]){{}, {}, {}}))
        )
        + 1
    );
    score += probe(
        reforward_items_twice(
            1
            + (0
                   ? (++b_unselected, forward_items_twice((struct Item[3]){{}, {}, {}}))
                   : forward_items_twice(
                         (struct Item[3]){
                             {.nested = {.values = {9}}},
    ...
    score += probe(
        reforward_items_twice(
            1
                ...
                : (++d_unselected, forward_items(&(struct Item[3]){{}, {}, {}}[1]))
        )
    );
    ...
    score += read_const(
        reforward_const_items(
            1
                ...
                : (++e_unselected, forward_const_items((ConstItems){{}, {}, {}}))
        )
        + 1
    );
    score += read_const(
    ...
    score += read_const(
        &reforward_const_items_twice(
            0
                ? (++g_unselected, forward_const_items_twice((ConstItems){{}, {}, {}}))
                : forward_const_items_twice(
                      (ConstItems){
                          {.nested = {.values = {9}}},
