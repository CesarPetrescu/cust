...
int main(void) {
    ...
    struct NamedHolder *named = &(struct NamedHolder){
        .nested = {
            .primary = {
                {.nested = {.values = {3}}},
                {.capture = ++named_capture, .nested = {.values = {5, 7, 9, 11}}},
                {},
            },
        },
    };
    struct AnonymousHolder *anonymous = &(struct AnonymousHolder){
        .nested = {
            .primary = {
                {.nested = {.points = {{13}}}},
                {.capture = ++anonymous_capture, .nested = {.points = {{11}, {17}, {19}, {23}}}},
                {},
            },
        },
    };
    union Choice *choice = &(union Choice){
        .nested = {
            .primary = {
                {.nested = {.values = {3}}},
                {.capture = ++choice_capture, .nested = {.values = {5, 7, 9, 11}}},
                {},
            },
        },
    };
    ...
    score += read_values(1 + choice->nested.primary);
    return score
