...
const COMPAT_FIXTURES: &[&str] = &[
    ...
    "tests/fixtures/compat/valid/embedded_aggregate_array_element_pointer_field_updates.c",
    ...
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_embedded_array_fields.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_recursive_identity_model_routes.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_alias_mutation_model_routes.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_nested_path_alias_mutation_routes.c",
    ...
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_wrapped_direct_compound_literal_outer_forwarding_routes.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_post_forward_wrapped_direct_compound_literal_routes.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_post_wrapper_reforwarded_direct_compound_literal_routes.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_mutable_to_const_reforwarded_direct_compound_literal_routes.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_compound_literal_field_offset_routes.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_wrapped_compound_literal_field_offset_routes.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_wrapped_compound_literal_field_outer_forwarding_routes.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_post_forward_wrapped_compound_literal_field_routes.c",
    ...
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_callee_internal_derived_inner_pointer_returns.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_callee_internal_reforwarded_derived_inner_pointer_returns.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_caller_reforwarded_derived_inner_pointer_returns.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_outer_caller_returned_derived_inner_pointers.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_final_receiving_caller_reforwarded_derived_inner_pointers.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_final_received_const_parameter_reentry.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_const_parameter_return_selection.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_nested_const_parameter_return_selection.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_post_selection_wrappers_and_offsets.c",
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_post_selection_reforward_return_boundaries.c",
    ...
    "tests/fixtures/compat/valid/adjusted_aggregate_parameter_captured_field_derived_inner_pointer_const_reforward_routes.c",
    ...
    "tests/fixtures/compat/valid/pointer_return_function_model_routes.c",
    ...
    "tests/fixtures/compat/valid/field_backed_mixed_qualification_parameter_alias_model_routes.c",
    "tests/fixtures/compat/valid/field_backed_pointer_return_forwarding_model_routes.c",
    "tests/fixtures/compat/valid/field_backed_pointer_return_alias_mutation_model_routes.c",
    "tests/fixtures/compat/valid/nested_anonymous_field_backed_pointer_return_alias_mutation_model_routes.c",
    "tests/fixtures/compat/valid/aggregate_compound_literal_field_pointer_alias_mutation_model_routes.c",
    "tests/fixtures/compat/valid/nested_anonymous_aggregate_compound_literal_field_pointer_alias_mutation_model_routes.c",
    "tests/fixtures/compat/valid/equality_classification_model_routes.c",
    "tests/fixtures/compat/valid/ordering_classification_model_routes.c",
    "tests/fixtures/compat/valid/truthiness_classification_model_routes.c",
    ...
    "tests/fixtures/compat/valid/initializer_element_context_classification_model_routes.c",
    "tests/fixtures/compat/valid/scalar_operand_context_classification_model_routes.c",
    "tests/fixtures/compat/valid/pointer_truthiness_and_equality.c",
    "tests/fixtures/compat/valid/reverse_subscript.c",
    "tests/fixtures/compat/valid/scalar_variable_reverse_subscript.c",
    "tests/fixtures/compat/valid/sizeof_scalar_reverse_subscripts.c",
    ...
    "tests/fixtures/compat/valid/bounded_string_copy_function.c",
    "tests/fixtures/compat/valid/string_tokenization_function.c",
    ...
    "tests/fixtures/compat/valid/bool_conversion_context_model_routes.c",
