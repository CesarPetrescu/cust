...
- `tests/fixtures/compat/valid/unions.c`, `tests/fixtures/compat/valid/nested_union_fields.c`, `tests/fixtures/compat/valid/union_pointers.c`, `tests/fixtures/compat/valid/union_return_functions.c`, and `tests/fixtures/compat/valid/aggregate_initializer_expressions.c` compare supported scalar union behavior against a native C compiler as an external oracle.
