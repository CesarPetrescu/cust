...
Work-package evaluation considered bounded character-storage `memset`, broader integer/aggregate object-representation serialization, a v0.21.0 package release, and lower-priority parser/fuzz expansion. `memset` was selected because it was first in both authoritative queues, completes the coherent four-intrinsic character-storage raw-memory package, and avoids inventing host ABI layout. Next, prepare and publish bounded v0.21.0; broader object representations remain separate design work.
