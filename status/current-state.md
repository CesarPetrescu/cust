...
- integer literals (decimal, C-style octal such as `052`, and hexadecimal such as `0x2a` / `0X10`), character literals, string literals, variables, and one-dimensional `int`/`char` arrays
