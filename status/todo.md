...
1. Continue improving parser recovery/error messages for additional malformed programs (for example missing `)` in grouped expressions/function calls/control-flow headers, unmatched delimiters, and malformed `for` clauses).
