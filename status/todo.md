...
1. Extend pointer support to parameters and array/string decay from `docs/plans/pointer-model.md`; acceptance: `int *`/`char *` parameters, array-base pointer indexing, string-literal read-only write diagnostics, and interpreter-only fixtures with explicit expected results.
