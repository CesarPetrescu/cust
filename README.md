...
- Next milestone: extend the bounded character-storage byte model with exactly prototyped `memset`, without exposing host addresses or bypassing interpreter-owned provenance.
