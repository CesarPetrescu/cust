...
- one-line object-like `#define` macros with nested token expansion in declarations, integer constant expressions, and runtime expressions, plus bounded `#undef` definition-lifetime support; comments and string/character literals are not macro-expanded
