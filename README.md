...
- Next language slice: make C11 `#line` source-name/line remapping implementation-ready with direct, macro-expanded, nested-header, and exact-diagnostic fixtures before changing source-origin metadata.
