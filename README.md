...
- Next milestone: implement bounded explicitly prototyped `strspn` and `strcspn` together, reusing two-sequence validation while returning deterministic initial-segment lengths for membership and non-membership.
