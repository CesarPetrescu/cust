...
- Next milestone: prepare bounded v0.25.0 around the completed deterministic standalone scalar object-byte raw-memory slice, with synchronized package/Docker/CLI/docs metadata and exact executable inventory checks.
