...
- Next preprocessing slice: scope bounded `#pragma once` support for project-relative quoted headers while retaining exact diagnostics for every other unsupported pragma.
