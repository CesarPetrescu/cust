...
> Status: **v0.5.0** — tested, Dockerized deterministic C-subset interpreter.
...
- Next preprocessing slice: scope bounded C99/C11 `_Pragma("once")` support for file-aware headers while retaining exact diagnostics for malformed and unsupported pragma operators.
