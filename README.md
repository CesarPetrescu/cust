...
- Next milestone: add explicitly prototyped C11 `rand` and `srand` intrinsics with deterministic interpreter-owned state, reproducible default and seeded sequences, exact declaration/arity/type diagnostics, user-definition precedence, and non-evaluating `sizeof` validation.
